		...
		>
			...
			<nav className="p-4">
				<ul className="space-y-2">
					...
					<li>
						<a href="/about" className="block p-2 rounded hover:bg-gray-700">
							About
						</a>
					</li>
					<li>
...
export const SideNavTrigger: FC<ISideNavTriggerProps> = ({
	...
	return (
		<button
			onClick={onClick}
			className={`fixed top-4 left-4 p-3 rounded-full bg-gray-800 text-white hover:bg-gray-700 transition-opacity duration-300 ${
